...
大家有兴趣的话，可以拿这些图片丢到各厂商的 OCR 中测试下效果。  
...
通过上面例子中的介绍，我们可以看到一个“OCR”任务，在最终交付落地的时候，其实变成了“目标检测+OCR”或者“目标检测+目标检测”的ML模型实现，与最初销售带回来的需求“客户需要一个集装箱号的识别”相比，事实上是做了任务扩展与定制化模型训练的工作。
